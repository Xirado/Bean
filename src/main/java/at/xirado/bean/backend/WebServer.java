...
import at.xirado.bean.backend.routes.GetGuildPage;
import at.xirado.bean.backend.routes.GetGuilds;
import at.xirado.bean.backend.routes.GetTokens;
import at.xirado.bean.backend.routes.GetURL;
...
public class WebServer
{
    ...
    public final Map<String, DataObject> USER_CACHE = new ConcurrentHashMap<>();
