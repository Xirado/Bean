...
public abstract class MessageContextCommand implements GenericCommand
{
    ...
    public void setCommandData(CommandData commandData)
    {
        if (commandData.getType() != Command.Type.MESSAGE)
            throw new IllegalArgumentException("Only CommandData of type MESSAGE is allowed!");
     ...
     */
    public abstract void executeCommand(@Nonnull MessageContextInteractionEvent event);
}
