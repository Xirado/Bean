...
public class CaseCommand extends SlashCommand
{
    public CaseCommand()
    {
        setCommandData(new CommandData("case", "show/modify a moderation case")
                .addSubcommands(new SubcommandData("show", "show information about a modcase")
                        .addOption(OptionType.STRING, "case", "the case to show infos about", true)
                )
                .addSubcommands(new SubcommandData("reason", "change the reason of a modcase")
                ...
                .addSubcommands(new SubcommandData("delete", "delete a modcase")
    ...
    public void executeCommand(@NotNull SlashCommandEvent event, @Nullable Member sender, @NotNull SlashCommandContext ctx)
    {
        ...
        if (event.getSubcommandName().equals("show"))
        {
            ...
            if (modCase == null)
            {
                ctx.reply(EmbedUtil.errorEmbed(ctx.getLocalized("commands.casecmd.not_exists", caseID.toUpperCase()))).setEphemeral(true).queue();
                return;
            }
